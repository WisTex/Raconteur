...
class Permissions
{
    ...
    public static function Perms($filter = ''): array
    {
        ...
        $perms = [
            ...
            'search_stream'  => t('Grant search access to your channel stream and posts'),
            ...
            'post_mail'      => t('Accept delivery of direct messages and personal mail from'),
            'send_stream'    => t('Accept delivery of posts and conversations from'),
            'post_comments'  => t('Accept delivery of comments on your posts from'),
