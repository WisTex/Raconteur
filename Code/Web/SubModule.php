...
class SubModule
{
     ...
     * This means we'll look for a class Plugins in Code/Module/Admin/Plugins.php
    ...
    public function __construct($whicharg = 1)
    {
        ...
        $filename = 'Code/Module/' . ucfirst(argv(0)) . '/' . ucfirst(argv($whicharg)) . '.php';
        $modname = '\\Code\\Module\\' . ucfirst(argv(0)) . '\\' . ucfirst(argv($whicharg));
