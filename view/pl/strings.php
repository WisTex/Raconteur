...
App::$strings["Your site photo is visible to anybody on the internet and may be distributed to other websites."] = "Zdjęcie Twojej witryny jest widoczne dla każdego w internecie i może być rozpowszechniane na innych witrynach internetowych.";
App::$strings["Use Photo for Site Logo"] = "Użyj zdjęcia jako logo witryny";
App::$strings["Change Site Logo"] = "Zmień logo witryny";
...
App::$strings["The recommended setting is to only allow unfiltered HTML from the following sites:"] = "Zalecanym ustawieniem jest zezwolenie na niefiltrowany kod HTML tylko z następujących witryn:";
...
App::$strings["All other embedded content will be filtered, <strong>unless</strong> embedded content from that site is explicitly blocked."] = "Wszystkie inne osadzone treści będą filtrowane, <strong> chyba że </strong> osadzone treści z tej witryny są jawnie zablokowane.";
...
App::$strings["If a public server policy is selected, this information may be displayed on the public server site list."] = "Jeśli została wybrana zasada serwera publicznego, informacje te mogą być wyświetlane na liście witryn serwerów publicznych.";
...
App::$strings["Will not waste system resources polling external sites for abandonded accounts. Enter 0 for no time limit."] = "Nie marnuje zasobów systemowych na odpytywanie zewnętrznych witryn w poszukiwaniu porzuconych kont. Wpisz 0, aby nie mieć ograniczeń czasowych.";
...
App::$strings["Public stream"] = "Strumień publiczny";
App::$strings["Provide access to public content from other sites. Warning: this content is unmoderated."] = "Zapewnij dostęp do treści publicznych z innych witryn. Ostrzeżenie: ta zawartość jest niemoderowana.";
...
App::$strings["Show numbers of likes and dislikes in conversations"] = "Pokaż w rozmowach liczbę pochwał i nagan";
App::$strings["If disabled, the presence of likes and dislikes will be shown, but without totals."] = "Jeśli ta opcja jest wyłączona, liczba pochwał i nagan będzie widoczna, ale bez podsumowania.";
...
App::$strings["Website"] = "Witryna internetowa";
...
App::$strings["no"] = "nie";
App::$strings["yes"] = "tak";
App::$strings["<a href=\"sites\">Show affiliated sites - some of which may allow registration.</a>"] = "<a href=\"sites\">Pokaż stowarzyszone witryny - niektóre z nich mogą zezwalać na rejestrację.</a>";
...
App::$strings["__ctx:title__ Dislikes"] = "Nagan";
...
App::$strings["Federated transport protocols:"] = "Sfederowane protokoły transportowe:";
...
App::$strings["Added by superblock"] = "Dodane przez superblock";
App::$strings["Everything"] = "Everything";
...
App::$strings["OAuth1 apps"] = "Aplikacje OAuth1";
...
App::$strings["Date Unthreaded"] = "Data woisu bezwątkowego";
...
App::$strings["(is on)"] = "(jest włączone)";
App::$strings["(is off)"] = "(jest wyłączone)";
App::$strings["Content filtering"] = "Filtrowanie treści";
App::$strings["Logout"] = "Wyloguj soę";
...
App::$strings["This post contains an installable %s element, however you lack permissions to install it on this site."] = "Ten wpis zawiera element %s, który można instalować, jednak nie masz uprawnień do zainstalowania go w tej witrynie.";
