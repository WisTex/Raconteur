...
App::$strings["Go to your new hub <a href=\"\$baseurl/register\">registration page</a> and register as new member. Remember to use the same email you have entered as administrator email. This will allow you to enter the site admin panel."] = "Przejdź do <a href=\"\$baseurl/register\">strony rejestracji</a> nowego portalu i zarejestruj się jako nowy członek. Pamiętaj, aby użyć tego samego adresu e-mail, który wprowadziłeś jako adres e-mail administratora. Umożliwi to wejście do panelu administracyjnego witryny.";
