...
App::$strings["Go to your new hub "] = "Przejdź do swojego nowego portalu ";
App::$strings["registration page"] = "strony rejestracji";
App::$strings["and register as new member. Remember to use the same email you have entered as administrator email. This will allow you to enter the site admin panel."] = "i zarejestruj się jako nowy członek. Pamiętaj, aby użyć tego samego adresu e-mail, który wprowadziłeś jako adres e-mail administratora. Umożliwi to wejście do panelu administracyjnego witryny.";
