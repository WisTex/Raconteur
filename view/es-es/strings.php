...
App::$strings["May not attend %1\$s's %2\$s"] = "No podrá asistir %2\$sde %1\$s";
...
App::$strings["This app is installed. The Notes tool can be found on your network stream page."] = "Esta aplicación está instalada. La herramienta Notas se encuentra en su página del stream de la red.";
...
App::$strings["Provides basic conversational access to software supporting the ActivityPub protocol."] = "Proporciona un acceso conversacional básico al software que soporta el protocolo ActivityPub.";
...
App::$strings["Expiration period in days for imported streams"] = "Periodo de caducidad en días de los \"streams\" importados";
...
App::$strings["This app (when installed) presents a slider control in your connection editor and also on your network page. The slider represents your degree of friendship with each connection. It allows you to zoom in or out and display conversations from only your closest friends or everybody in your stream."] = "Esta aplicación (cuando está instalada) presenta un control deslizante en su editor de conexión y también en su página de red. El control deslizante representa su grado de amistad con cada conexión. Le permite acercar o alejar y mostrar conversaciones sólo de sus amigos más cercanos o de todo el mundo en su stream.";
App::$strings["The number below represents the default maximum slider position for your network/stream page as a percentage."] = "El número que aparece a continuación representa la posición máxima predeterminada del control deslizante para su red/stream en porcentaje.";
...
App::$strings["Network page max height of content (in pixels)"] = "Altura máxima del contenido de la página de la red (en píxeles)";
...
App::$strings["Unseen network activity"] = "Actividad de red no vista";
...
App::$strings["Activity Filters"] = "Filtros de actividad";
...
App::$strings["view full size"] = "ver en tamaño completo";
