...
App::$strings["Accept delivery of their posts and comments to their posts"] = "Aceptar la transmisión de sus entradas y comentarios a sus posts";
...
App::$strings["Experimental and unsupported. ActivityPub does not fully support privacy and account mobility."] = "Experimental y sin soporte. ActivityPub no es totalmente compatible con la privacidad y la movilidad de la cuenta.";
...
App::$strings["Remove from menu"] = "Eliminar del menú";
...
App::$strings["Enable hyperdrive"] = "Habilitar hyperdrive";
...
App::$strings["It provides access to a large and growing number of existing users and supported software applications, however it is still evolving. If this is enabled you will obtain much greater social reach, however you will almost certainly encounter compatibility issues, with varying levels of severity and personal impact. "] = "Proporciona acceso a un número grande y creciente de usuarios existentes y aplicaciones de software soportadas, pero aún está evolucionando. Si esto es posible, usted obtendrá un alcance social mucho mayor, sin embargo, es casi seguro que encontrará problemas de compatibilidad, con diferentes niveles de severidad e impacto personal. ";
App::$strings["Your system administrator has allowed this experimental service on this website. Please disable it if you prefer a bit more stability in your life."] = "El administrador del sistema ha permitido este servicio experimental en este sitio Web. Por favor, desactívelo si prefiere un poco más de estabilidad en su vida.";
...
App::$strings["OAuth2 apps"] = "Apps OAuth2";
