...
App::$strings["This app allows you to set an optional expiration date/time for posts, after which they will be deleted. This must be at least fifteen minutes into the future. You may also choose to automatically delete all your posts after a set number of days"] = "Esta aplicación le permite establecer una fecha/hora de caducidad opcional para las entradas, después de la cual serán eliminadas. Esto debe ser de por lo menos quince minutos en el futuro. También puede elegir borrar automáticamente todas sus entradas después de un número determinado de días.";
...
App::$strings["This app creates dynamic access lists corresponding to [1] all connections, [2] all ActivityPub protocol connections, and [3] all Zot/6 protocol connections. These additional selections will be found within the Permissions setting tool."] = "Esta aplicación crea listas de acceso dinámicas correspondientes a [1] todas las conexiones, [2] todas las conexiones del protocolo ActivityPub y [3] todas las conexiones del protocolo Zot/6. Estas selecciones adicionales se encontrarán dentro de la herramienta de configuración de permisos.";
...
App::$strings["My Zot connections"] = "Mis conexiones Zot";
...
App::$strings["Post permissions cannot be changed after a post is shared.</br />These permissions set who is allowed to view the post."] = "Los permisos de publicación no se pueden cambiar después de que se comparte una publicación. </br /> Estos permisos establecen quién puede ver el mensaje.";
...
App::$strings["Search site @name, #tag, content"] = "Buscar sitio @nombre, #etiqueta, contenido";
