	...
	function getFileMimeType(result, address) {
		...
		switch(result.filetype) {
			...
			case "text/vnd.abc":
				...
				return `<li class="border rounded my-1 p-2" onclick ="setEmbedFiles('${sendabc}')" data-bs-dismiss="modal" ><h4>${result.filename}</h4><iframe src="https://streams.hubzilla.social/dav/ray/${result.display_path}" scrolling="no" ></iframe></li>`;
			case "text/plain":
