	...
	function getFileMimeType(result, address) {
		...
		switch(result.filetype) {
			...
			case "image/gif":
				  ...
				  let $send = `[zrl=${baseurl}/cloud/${address}/${result.hash}][/zrl][zmg class="img-fluid img-thumbnail" alt="${result.filename}" src="${baseurl}/cloud/${address}/{result.display_path}"][/zmg]`;
