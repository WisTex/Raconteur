		...
		switch(result.filetype) {
			...
			/*alert(JSON.stringify(result)); */
				...
				{{* return `<li onclick ="setEmbedFiles('${send}')" data-bs-dismiss="modal" ><img src="/cloud/${address}/${result.display_path}" class="img-fluid img-thumbnail" ></li>`; *}}
				  return `<li onclick ="setEmbedFilesOne(${this.result} ${address})" data-bs-dismiss="modal" ><img src="/cloud/${address}/${result.display_path}" class="img-fluid img-thumbnail" ></li>`;
			case "video/mp4":
			case "video/webm":
			case "video/ogg":
