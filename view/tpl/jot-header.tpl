...
let postSaveTimer = null;
	...
	function getFileMimeType(result, address) {
		...
		switch(result.filetype) {
			...
			case "video/mp4":
    			  return `<li class="border rounded my-1 p-2" ><h4 onclick ="alert('Working')">${result.filename}{{$clicktitle}}</h4><video poster="images/video_poster.jpg" controls="controls" preload="none" src="/cloud/${address}/${result.display_path}" style="width:100%;" /></li>`;
    		case "audio/mpeg":
