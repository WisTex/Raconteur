...
![screenshot showing location settings]([baseurl]/doc/develop/en/locationsettings.png)
...
![diagram showing location service buttons in post editor]([baseurl]/doc/develop/en/locationwitheditor.png)
...
![example post preview of a checkin activity]([baseurl]/doc/develop/en/checkin.png)